# Role Alignment: NYU Langone Data Harmonization Analyst / Data Science Analyst

| NYU Langone role responsibility | Project evidence | File/output | Skill demonstrated |
|---|---|---|---|
...
| Source-to-CDM mapping | Field-level mapping catalog with status, confidence, rules, and edge cases | `src/build_mapping_catalog.py`, `docs/Source_to_CDM_Mapping_Spec.md` | Harmonization analysis and steward review workflow |
